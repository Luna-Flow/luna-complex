...
Use this page to explain the structural responsibilities and implementation constraints of this module. double_ext in Luna-Flow/luna-complex.

## Responsibilities

- Keep the code and docs aligned around `src/double_ext`.
