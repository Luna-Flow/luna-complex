...
double_ext is part of Luna-Flow/luna-complex. This page should describe the public types, constructors, functions, traits, and observable semantics that are implemented in the current branch.

## Scope

- Source boundary: `src/double_ext`
